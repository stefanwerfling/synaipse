...
Available tools: `synaipse_get_project`, `_search`, `_read_note`, `_write_note`, `_update_note`, `_delete_note`, `_list_notes`, `_list_tags`, `_notes_by_tag`, `_backlinks`, `_outgoing_links`, `_link_note`, `_related`, `_suggest_links`, `_graph`, `_recent`, `_stale`, `_todos`, `_log_session`. Full reference: [doc/mcp-tools.md](doc/mcp-tools.md).
